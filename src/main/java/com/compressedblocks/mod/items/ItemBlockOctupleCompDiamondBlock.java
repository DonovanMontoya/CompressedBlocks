...
public class ItemBlockOctupleCompDiamondBlock extends ItemBlock

{
    public ItemBlockOctupleCompDiamondBlock(Block p_i45328_1_) {
        super(p_i45328_1_);
    }
    ...
    public void addInformation(ItemStack p_77624_1_, EntityPlayer p_77624_2_, List lines, boolean p_77624_4_) {
        lines.add("43,046,721 Diamond Blocks");
