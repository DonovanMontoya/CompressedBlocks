...
public class ItemBlockSextupleCompDiamondBlock extends ItemBlock

{
    public ItemBlockSextupleCompDiamondBlock(Block p_i45328_1_) {
        super(p_i45328_1_);
    }
    ...
    public void addInformation(ItemStack p_77624_1_, EntityPlayer p_77624_2_, List lines, boolean p_77624_4_) {
        lines.add("531,441 Diamond Blocks");
